...
**
** Il win_h a des differences entre X11 et MacOS.
...
/*
**  origin for win_w & win_h is top left corner of the window
**  win_h down is positive
**  color is 0x00RRGGBB
*/
...
**   mouse_hook(int button, int win_w,int win_h, void *param);
